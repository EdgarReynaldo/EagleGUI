...
///   EagleFont(std::string name);
   ...
   virtual int VHeight(std::string str)=0;///< Pure virtual function to get the height of a vertical string
   virtual int VWidth(std::string str , int ls)=0;///< Pure virtual function to get the width of a vertical string (may be multi-line)
